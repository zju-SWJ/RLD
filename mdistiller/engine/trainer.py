...
class BaseTrainer(object):
    def __init__(self, experiment_name, distiller, train_loader, val_loader, cfg):
        ...
        self.log_path = os.path.join(cfg.LOG.PREFIX, experiment_name, current_time)
        os.makedirs(self.log_path)
        write_cfg(cfg, self.log_path)
    ...
    def log(self, lr, epoch, log_dict):
        ...
        self.tf_writer.add_scalar("best_test_acc", self.best_acc, epoch)
        self.tf_writer.flush()
        # worklog.txt
