...
class MLKD_NOAUG(Distiller):
    def __init__(self, student, teacher, cfg):
        super(MLKD_NOAUG, self).__init__(student, teacher)
    ...
    def forward_train(self, image, target, **kwargs):
        logits_student_weak, _ = self.student(image)
        with torch.no_grad():
            logits_teacher_weak, _ = self.teacher(image)

        batch_size, class_num = logits_student_weak.shape
